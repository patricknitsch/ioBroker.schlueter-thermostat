				...
				controls: [
					...
					},
					{
						...
						options: [
							...
							{ value: 4, label: { en: 'Vacation', de: 'Urlaub' }, icon: 'book', color: '#00acc1' },
							{ value: 6, label: { en: 'Frost Protection', de: 'Frostschutz' }, icon: 'ac_unit', color: '#03a9f4' },
							{ value: 8, label: { en: 'Boost', de: 'Boost' }, icon: 'play', color: '#f44336' },
