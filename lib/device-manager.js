		...
		return {
			...
			items: {
				...
				controls: {
					...
					items: {
						_h2: {type: 'header', text: { en: 'Manual Mode', de: 'Manueller Modus' }, sm: 12, newLine: true},
						...
						_h4: {type: 'header', text: { en: 'Schedule Mode', de: 'Zeitplan Modus' }, sm: 12, newLine: true},
						...
						_h7: {type: 'header', text: { en: 'Vacation Mode', de: 'Urlaubs Modus' }, sm: 12, newLine: true},
						...
						_h8: {type: 'header', text: { en: 'Name Set', de: 'Namens Anpassung' }, sm: 12, newLine: true},
