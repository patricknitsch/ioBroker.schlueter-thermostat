		...
		return {
			...
			items: {
				...
				controls: {
					...
					items: {
						_h1: {type: 'header', text: { en: 'Manual Mode', de: 'Manueller Modus' }, sm: 12, newLine: true},
           			    _d1: {type: 'divider', color: 'primary'},
						manualSetpoint: {
							type: 'state',
						...
						_h1: {type: 'header', text: { en: 'Comfort Mode', de: 'Komfort Modus' }, sm: 12, newLine: true},
           			    _d1: {type: 'divider', color: 'primary'},
						comfortSetpoint: {
							type: 'state',
						...
						_h1: {type: 'header', text: { en: 'Schedule Mode', de: 'Zeitplan Modus' }, sm: 12, newLine: true},
           			    _d1: {type: 'divider', color: 'primary'},
						applySchedule: {
							type: 'setState',
						...
						_h1: {type: 'header', text: { en: 'Eco Mode', de: 'Eco Modus' }, sm: 12, newLine: true},
           			    _d1: {type: 'divider', color: 'primary'},
						applyEco: {
							type: 'setState',
						...
						_h1: {type: 'header', text: { en: 'Boost Mode', de: 'Boost Modus' }, sm: 12, newLine: true},
           			    _d1: {type: 'divider', color: 'primary'},
						boostDuration: {
							type: 'state',
						...
						_h1: {type: 'header', text: { en: 'Vacation Mode', de: 'Urlaubs Modus' }, sm: 12, newLine: true},
           			    _d1: {type: 'divider', color: 'primary'},
						vacationEnabled: {
							type: 'state',
						...
						_h1: {type: 'header', text: { en: 'Name Set', de: 'Namens Anpassung' }, sm: 12, newLine: true},
           			    _d1: {type: 'divider', color: 'primary'},
						nameValue: {
							type: 'state',
