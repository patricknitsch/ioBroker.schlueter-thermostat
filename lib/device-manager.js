...
=======
						_h1: { type: 'header', text: { en: 'Information', de: 'Informationen' }, sm: 12, newLine: true },
           				_d1: { type: 'divider', color: 'primary' },
>>>>>>> main
						groupId: {
							type: 'staticInfo',
...
<<<<<<< copilot/fix-prettier-issues
						...
						_h2_1: { type: 'header', text: { en: 'Manual Mode', de: 'Handbetrieb' }, sm: 12, newLine: true },
						_d2: { type: 'divider', color: 'primary' },
=======
						_h2: { type: 'header', text: { en: 'Manual Mode', de: 'Handbetrieb' }, sm: 12, newLine: true },
           			    _d2: { type: 'divider', color: 'primary'},
>>>>>>> main
						manualSetpoint: {
							type: 'state',
...
<<<<<<< copilot/fix-prettier-issues
						_h3: { type: 'header', text: { en: 'Comfort Mode', de: 'Komfort Betrieb' }, sm: 12, newLine: true },
						_d3: { type: 'divider', color: 'primary' },
=======
						_h3: { type: 'header', text: { en: 'Comfort Mode', de: 'Komfort Modus' }, sm: 12, newLine: true },
           			    _d3: { type: 'divider', color: 'primary' },
>>>>>>> main
						comfortSetpoint: {
							type: 'state',
...
=======
						_h5: { type: 'header', text: { en: 'Eco Mode', de: 'Energiesparen' }, sm: 12, newLine: true },
           			    _d5: { type: 'divider', color: 'primary' },
>>>>>>> main
						applyEco: {
							type: 'setState',
...
=======
						_h6: { type: 'header', text: { en: 'Boost Mode', de: 'Boost Modus' }, sm: 12, newLine: true },
           			    _d6: { type: 'divider', color: 'primary' },
>>>>>>> main
						boostDuration: {
							type: 'state',
						...
						_h7: { type: 'header', text: { en: 'Vacation Mode', de: 'Urlaubsmodus' }, sm: 12, newLine: true },
<<<<<<< copilot/fix-prettier-issues
...
<<<<<<< copilot/fix-prettier-issues
						_h8: { type: 'header', text: { en: 'Thermostat name', de: 'Thermostat Name' }, sm: 12, newLine: true },
