...
class OJClient {
	/**
	 * @param {{log:any, provider:string, baseUrlOwd5?:string, username:string, password:string, apiKey:string, customerId:number, clientSwVersion?:number}} cfg
	 */
	constructor(cfg) {
		this.log = cfg.log;
		/** @type {'owd5'} */
		this.provider = 'owd5';
		// keep cfg.provider for diagnostics only
		this._cfgProvider = cfg.provider || 'owd5';
